#!/usr/bin/env python3
"""
Script to extract examples from data/gen_res directory in the same format as examples_11doc_better_than_1doc.txt
"""
...
def main():
    ...
    output_file = "/home/scur2158/The-Power-of-Noise/examples_gen_res.txt"
    
    # Data directories
    base_dir = "/home/scur2158/The-Power-of-Noise/data/gen_res"
    ...
    with open(output_file, 'w') as f:
        f.write("=" * 120 + "\n")
        f.write("EXAMPLES FROM data/gen_res\n")
        ...
        for idx, example_id in enumerate(example_ids):
            ...
            f.write(f"is match: {match_1}, answer in documents: {True}\n\n")
            ...
            f.write(f"is match: {match_11}, answer in documents: {True}\n\n")
