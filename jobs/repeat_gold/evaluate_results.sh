...
#SBATCH --gpus=1
#SBATCH --job-name=EvaluateResultsRepeatGold
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=9
#SBATCH --time=00:15:00
#SBATCH --output=output/test_evaluate_repeat_gold_%A.out
...
evaluate_experiment() {
    ...
    echo "=========================================="
    echo "Evaluating: repeat_gold (gold document repeated ${num_docs} times)"
...
for NUM_DOCUMENTS in "${NUM_DOCUMENTS_LIST[@]}"; do
    echo "=========================================="
    echo "Evaluating Results for ${NUM_DOCUMENTS} documents (repeat_gold)"
    echo "=========================================="
    
    evaluate_experiment $NUM_DOCUMENTS
