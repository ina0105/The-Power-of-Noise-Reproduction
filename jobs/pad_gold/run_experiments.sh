...
#SBATCH --gpus=1
#SBATCH --job-name=PadGold
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=9
#SBATCH --time=03:30:00
#SBATCH --output=output/slurm_output_experiments_pad_gold_%A.out
...
run_experiment() {
    ...
    echo "=========================================="
    echo "Running experiment: near scenario with random documents (pad_gold)"
    ...
    echo "Completed: near scenario with random documents, pad_gold (${num_docs} docs)"
    echo ""
}

# List of NUM_DOCUMENTS to run experiments for
#NUM_DOCUMENTS_LIST=(1 2 3 5 7 9 11)
NUM_DOCUMENTS_LIST=(13 15)
