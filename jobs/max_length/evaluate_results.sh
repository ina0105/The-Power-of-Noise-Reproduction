...
#SBATCH --gpus=1
#SBATCH --job-name=EvaluateResultsMaxLength
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=9
#SBATCH --time=00:15:00
#SBATCH --output=output/test_evaluate_max_length_%A.out
...
#OUTPUT_DIR="data/gen_res_max_length"
...
evaluate_experiment() {
    ...
    echo "=========================================="
    echo "Evaluating: near scenario with random documents"
...
for NUM_DOCUMENTS in "${NUM_DOCUMENTS_LIST[@]}"; do
    echo "=========================================="
    echo "Evaluating Results for ${NUM_DOCUMENTS} documents (near scenario, random)"
    echo "=========================================="
